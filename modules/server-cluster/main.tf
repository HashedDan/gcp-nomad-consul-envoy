...
resource "google_compute_instance_group_manager" "server" {
  ...
  depends_on = ["google_compute_instance_template.server_public", "google_compute_instance_template.server_private"]
}
...
resource "google_compute_instance_template" "server_public" {
...
resource "google_compute_instance_template" "server_private" {
